...
export default class ManageJob extends React.Component {
    ...
    loadData(callback) {
        var link = 'http://mvptalent.azurewebsites.net/listing/listing/getSortedEmployerJobs?' + this.getSortedJobsParams();
        //var link = 'http://localhost:51689/listing/listing/getSortedEmployerJobs?' + this.getSortedJobsParams();
    ...
    handleCloseJob(jobData) {
        ...
        this.setState({ loaderData: loader }, () => {
            $.ajax({
                ...
                url: 'http://mvptalent.azurewebsites.net/listing/listing/closeJob',
                headers: {
